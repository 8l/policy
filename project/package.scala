...
sealed abstract class PolicyPackage extends Constants with PluginRelatedCode with BuildTasks with PolicyHelpers with Depends with Runners with Bootstrap
